  ...
  async function handleSetPassword() {
    ...
    try {
      ...
      if (supaErr) {
        ...
        setSuccess(true);
        setTimeout(() => router.replace('/client-login' as any), 3000);
      }
    } catch {
  ...
  return (
    <View style={styles.root}>
      <View style={styles.topBar}>
        <Text style={styles.topTitle}>Business Portal — Reset Password</Text>
      </View>
        ...
        <View style={styles.card}>
          {success ? (
            <View style={styles.successBox}>
              ...
              <Text style={styles.successMsg}>Your password has been changed. Redirecting to login…</Text>
            </View>
          ) : sessionError ? (
            <View style={styles.expiredBox}>
              ...
              <TouchableOpacity style={styles.loginBtn} onPress={() => router.replace('/client-login' as any)}>
            ...
            <>
              ...
              <Text style={styles.cardSub}>Choose a strong password for your business portal account.</Text>
...
const styles = StyleSheet.create({
  ...
  errorBanner: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: Colors.dangerLight, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, marginBottom: 14 },
