...
const STEP_LABELS = ['Personal Info', 'Location', 'Bank Details', 'Password'];
...
export default function AgentRegisterScreen() {
  ...
  async function handleSubmit() {
    ...
    setLoading(true);
    try {
      await registerAgent({ fullName, email, phone, state, lga, city, accountName, accountNumber, referredBy: referredBy.trim() || undefined, password });
      setSuccess(true);
    } catch (e: any) {
    ...
    return (
      <View style={styles.successScreen}>
        ...
        <Text style={styles.successText}>
          Your agent application has been received. Our team will review and approve your account shortly. You'll be able to log in once approved.
        </Text>
  ...
  return (
    <ScrollView style={styles.root} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.card}>
        ...
        {step === 2 && (
          <>
            <Text style={styles.bankNote}>Enter your Nigerian bank account details for commission payouts.</Text>
